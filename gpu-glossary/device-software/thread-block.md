...
can be arbitrarily sized by the
[launch configuration](/gpu-glossary/device-software/kernel-launch-configuration),
up to a limit of 1024 on current devices, but they are typically multiples of
the [warp](/gpu-glossary/device-software/warp) size (32 on current devices).
